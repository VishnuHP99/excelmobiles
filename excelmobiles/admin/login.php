...
<head>
        <title>Excel Mobiles || Login Page</title><meta charset="UTF-8" />
    ...
    <body>
        <div id="loginbox">            
            <form id="loginform" class="form-vertical" method="post">
				 <div class="control-group normal_text"> <h3>Excel</strong> <strong style="color: orange">Mobiles</strong></h3></div>
