...
<head>
    ...
    <title>Excel Mobiles||Home Page</title>
                ...
                <div class="col-lg-9 col-xl-9">
                    ...
                    <div class="hero hero-slider hero---2">
                        <div class="swiper-wrapper">
                            <!-- Start Hero Image -->
                            <div class="hero-img hero-img--2 swiper-slide" style="background-image: url(assets/img/hero/main.png);">
                                <div class="hero__content">
                                    <div class="row">
                                        <div class="col-9 offset-1">
                                            <div class="title title--normal title--thin">New Arrivals</div>
                                            <div class="title title--normal title--regular">Get Mobile Acessories @ Great discounts </div>
                            ...
                            <!-- Start Hero Image -->
                            <div class="hero-img hero-img--2  swiper-slide" style="background-image: url(assets/img/hero/mainAcc.png);">
                                <div class="hero__content">
                                    <div class="row">
                                        <div class="col-9 offset-1">
                                            <div class="title title--normal title--white title--thin">Buy Mobiles</div>
                                            <div class="title title--normal title--white title--regular">Buy Mobiles at price like never before</div>
                            ...
                            <!-- Start Hero Image -->
                            <div class="hero-img hero-img--2 swiper-slide" style="background-image: url(assets/img/hero/thirdmain.png);">
                                <div class="hero__content">
                                    <div class="row">
                                        <div class="col-9 offset-1">
                                            <div class="title title--normal  title--thin">APPLE</div>
                                            <div class="title title--normal  title--regular">IPHONE 15</div>
                                            <div class="title title--description ">Sale Offer <span class="title--red">-30% Off</span> This Week</div>
                                            <a href="shop-mobile.php" class="btn btn--box btn--large btn--blue btn--uppercase btn--weight">Shop Now</a>
                                        </div>
                                    </div>
                                </div>
