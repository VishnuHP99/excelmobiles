...
<head>
    <title>Excel Mobiles||Cart</title>
    <!-- Vendor CSS Files -->
...
?>
                        ...
                        <?php
                           $totalCartItems = mysqli_num_rows(mysqli_query($con, "SELECT * FROM tblorders WHERE UserId = '".$_SESSION['msmsuid']."' AND IsOrderPlaced IS NULL"));

                            ?>

<input type="hidden" id="cartCount" value="<?php echo $totalCartItems; ?>">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="sidebar__widget gray-bg m-t-40">
                        ...
                        <a href="checkout.php" id="checkoutBtn" class="btn btn--box btn--blue">Proceed to Checkout</a>
    ...
    <script>
        document.getElementById("checkoutBtn").addEventListener("click", function(e) {
            var cartCount = parseInt(document.getElementById("cartCount").value);
            if (cartCount === 0) {
