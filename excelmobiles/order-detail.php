...
<head>
    <title>Excel Mobiles||My Orders</title>
    <!-- Vendor CSS Files -->
...
<a href="javascript:void(0);" onClick="popUpWindow('trackorder.php?oid=<?php echo $oid;?>');" title="Track order" style="color:#fff" class="btn btn--box btn--small btn--blue btn--uppercase btn--weight"> Track order
</a></p>

<?php } ?>
<!-- Invoice -->
<p>
 <a href="javascript:void(0);" onClick="popUpWindow('invoice.php?oid=<?php echo $oid;?>&&odate=<?php echo $od;?>');" title="Order Invoice" style="color:#fff" class="btn btn--box btn--small btn--blue btn--uppercase btn--weight">  Invoice</a></p>
                    <?php 
                                $userid= $_SESSION['msmsuid'];
