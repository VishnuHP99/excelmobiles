...
?>
                    ...
                    <div class="col-xl-4 col-lg-12 col-12">
                        ...
                        <div class="footer__form">
                            <h4 class="footer__nav-title">To Get Notified on our Latest Offers Subscribe here</h4>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-12 col-12">
                        <div class="footer__copyright-text">
                            <p style="color:red;font-size: 20px;text-align: center;">Excel Mobiles @2025</p>
                        </div>
                    </div>
